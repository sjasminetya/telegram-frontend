<template>
  <div>
    <div class="menu-top">
      <img
        src="../../assets/back.png"
        @click.prevent="handleBackSettings"
        alt="arrow back"
      />
    ...
    <div class="menu-info">
      ...
      <div class="info-account">
        <div class="input-number">
          ...
          <input
            type="text"
            class="form-control edit-number"
            v-model="phoneNumber"
            v-if="editPhoneNumber === 1"
            @keyup.enter="saveNumber"
          />
          <input
            type="text"
            class="form-control number"
            v-model="userLogin.phoneNumber"
            v-if="editPhoneNumber === 0"
            disabled
          />
          <span
            ><i
        ...
        <div class="input-bio">
          ...
          <input
            ...
            v-model="userLogin.bio"
            v-if="editBio === 0"
            disabled
          />
          <span
            ><i class="fas fa-pen" @click="editBioUser" v-if="editBio === 0"></i
          ></span>
          <span
            ><i class="fas fa-check" @click="saveBio" v-if="editBio === 1"></i
          ></span>
        </div>
      </div>
      <div class="location">
        ...
        <div class="map">
          <GmapMap
            :center="{
              lat: parseFloat(userLogin.lat),
              lng: parseFloat(userLogin.lng)
            }"
            :zoom="7"
            map-type-id="terrain"
...
export default {
  ...
  methods: {
    ...
    onSelect () {
      ...
      this.updateImage(formData).then(() => {
        Swal.fire({
          icon: 'success',
          title: 'Succeed',
          text: 'Success update',
